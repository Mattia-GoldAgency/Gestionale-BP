  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Card Scrittura Atti */}
        <Link href="/scrittura-atti" className="group bg-white rounded-lg border border-[var(--brand-gray)] p-8 hover:border-[var(--brand-blue)] hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center">
          ...
          <h3 className="font-title font-semibold text-xl text-[var(--brand-blue)] mb-2">Scrittura atti</h3>
          <p className="text-sm text-gray-500">Sezione dedicata alla redazione e automazione degli atti.</p>
        </Link>
        ...
        <Link href="/traduzioni" className="group bg-white rounded-lg border border-[var(--brand-gray)] p-8 hover:border-[var(--brand-blue)] hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center">
          ...
          <h3 className="font-title font-semibold text-xl text-[var(--brand-blue)] mb-2">Traduzioni e Trascrizioni testo</h3>
          <p className="text-sm text-gray-500">Servizio di traduzione e trascrizione dei documenti.</p>
        </Link>
